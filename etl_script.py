...
adm_df.to_csv('clean/admission_data.csv', index=False, header=True, sep=',')

mort_df.to_csv('clean/mortality_data.csv', index=False, header=True, sep=',')

poll_df.to_csv('clean/pollution_data.csv', index=False, header=True, sep=',')
